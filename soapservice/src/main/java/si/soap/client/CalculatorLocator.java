...
package si.soap.client;

public class CalculatorLocator extends org.apache.axis.client.Service implements si.soap.client.Calculator {
    ...
    public si.soap.client.CalculatorSoap_PortType getCalculatorSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public si.soap.client.CalculatorSoap_PortType getCalculatorSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            si.soap.client.CalculatorSoap12Stub _stub = new si.soap.client.CalculatorSoap12Stub(portAddress, this);
    ...
    public si.soap.client.CalculatorSoap_PortType getCalculatorSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public si.soap.client.CalculatorSoap_PortType getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            si.soap.client.CalculatorSoap_BindingStub _stub = new si.soap.client.CalculatorSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (si.soap.client.CalculatorSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                si.soap.client.CalculatorSoap12Stub _stub = new si.soap.client.CalculatorSoap12Stub(new java.net.URL(CalculatorSoap12_address), this);
                _stub.setPortName(getCalculatorSoap12WSDDServiceName());
                return _stub;
            }
            if (si.soap.client.CalculatorSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                si.soap.client.CalculatorSoap_BindingStub _stub = new si.soap.client.CalculatorSoap_BindingStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
